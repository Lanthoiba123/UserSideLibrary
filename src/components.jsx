...
export const SignInContainer = styled.div`
  ...
  width: 50%;
  z-index: 2;
  ${(props) => (props.signinin !== 1 ? `transform: translateX(100%);` : null)}
`;
...
export const Overlay = styled.div`
  ...
  transition: transform 0.6s ease-in-out;
  ${(props) => (props.signinin !== 1 ? `transform: translateX(50%);` : null)}
`;
...
export const LeftOverlayPanel = styled(OverlayPanel)`
  ...
  ${(props) => (props.signinin !== 1 ? `transform: translateX(0);` : null)}
`;

export const RightOverlayPanel = styled(OverlayPanel)`
  right: 0;
  transform: translateX(0);
  ${(props) => (props.signinin !== 1 ? `transform: translateX(20%);` : null)}
`;
